...
function createGrid(gridSize){
    if(gridSize < defaultGridSize || gridSize > maxGridSize){ 
        gridSize = defaultGridSize;
        alert(`Sorry, dimensions must range from ${defaultGridSize} to ${maxGridSize}!!`)
    }
...
// e.preventDefault stops UI action as mouseup's were being missed
